...
public class ShowMarksstudent extends AppCompatActivity {
    MarkListAdapter5 markListAdapter5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_marksstudent);
        ...
        markListAdapter5=new MarkListAdapter5(this,list);
        recyclerViewsecond.setAdapter(markListAdapter5);
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                markListAdapter5.notifyDataSetChanged();
